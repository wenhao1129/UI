...
#import setup_param.compare_version as compare_version
import compare_version.compare_version_with_md5 as compare_version
...
class MyWin(Ui_MainWindow, QMainWindow):
    ...
    def onChooseStation(self):
        ...
        while chooseStation == '版本比对':
              compare_version.MyWin.compare_version(self)
              time.sleep(1)
              break
