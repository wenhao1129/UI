...
class MyWin(Ui_MainWindow, QMainWindow):
    ...
    def navigation_back(self):
        self.data = subprocess.Popen('../reliability/navigation_back.sh', stdout=subprocess.PIPE,
        ...
        with open('tmp.txt', 'r') as backFile:
            ...
            for tempsetup in backFile.readlines():
                if backfailkeyword1 in tempsetup or backfailkeyword2 in tempsetup or backfailkeyword3 in tempsetup:
                    testStatusText_naviback = 'fail'
                    self.lineEdit_teststatus.setText(testStatusText_naviback)
                    ...
                    slws.MyWin.outer_logfile(self,testStatusText_naviback)
                    #sulws.MyWin.Self_logfile(self,testStatusText_naviback)
                    break
                elif backpasskeyword in tempsetup:
                    testStatusText_naviback = 'PASS'
                    templog = open('Ginger_UI_log.txt', 'a', encoding='utf-8')
                    templog.write('============================================================================\n')
                    templog.write('                       Ginger service test start                              \n')
                    templog.write('============================================================================\n')
                    ...
                    #sulws.MyWin.Self_logfile(self,testStatusText_naviback)
                    break
        return testStatusText_naviback
