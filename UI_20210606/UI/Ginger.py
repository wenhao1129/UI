...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_base.setGeometry(QtCore.QRect(0, 0, 1691, 121))
        ...
        self.label_13 = QtWidgets.QLabel(self.groupBox_base)
        self.label_13.setGeometry(QtCore.QRect(650, 80, 71, 41))
        self.label_13.setObjectName("label_13")
        self.progressBar = QtWidgets.QProgressBar(self.groupBox_base)
        self.progressBar.setGeometry(QtCore.QRect(720, 80, 241, 41))
        self.progressBar.setProperty("value", 24)
        self.progressBar.setObjectName("progressBar")
        self.label_14 = QtWidgets.QLabel(self.groupBox_base)
        self.label_14.setGeometry(QtCore.QRect(650, 30, 71, 41))
        self.label_14.setObjectName("label_14")
        self.lineEdit_MO = QtWidgets.QLineEdit(self.groupBox_base)
        self.lineEdit_MO.setGeometry(QtCore.QRect(720, 30, 241, 41))
        ...
        self.pushButton_stop.setGeometry(QtCore.QRect(1570, 30, 121, 91))
        font = QtGui.QFont()
        font.setPointSize(45)
        font.setBold(True)
        font.setItalic(False)
        ...
        self.pushbutton_SFIS_ON.setGeometry(QtCore.QRect(1300, 30, 111, 51))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setItalic(False)
        ...
        self.comboBox.setGeometry(QtCore.QRect(1300, 90, 111, 31))
        self.comboBox.setObjectName("comboBox")
        self.lineEdit = QtWidgets.QLineEdit(self.groupBox_base)
        self.lineEdit.setGeometry(QtCore.QRect(1420, 30, 141, 91))
        self.lineEdit.setObjectName("lineEdit")
        self.groupBox_information = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_information.setGeometry(QtCore.QRect(0, 120, 1331, 791))
        ...
        self.textBrowser.setGeometry(QtCore.QRect(10, 30, 1321, 611))
        self.textBrowser.setObjectName("textBrowser")
        self.groupBox_testtime = QtWidgets.QGroupBox(self.groupBox_information)
        self.groupBox_testtime.setGeometry(QtCore.QRect(640, 640, 371, 151))
        ...
        self.groupBox_programversion.setGeometry(QtCore.QRect(10, 640, 371, 151))
        ...
        self.groupBox_testresult.setGeometry(QtCore.QRect(390, 640, 241, 151))
        ...
        self.label_9.setGeometry(QtCore.QRect(1020, 660, 311, 111))
        self.label_9.setText("")
        self.label_9.setPixmap(QtGui.QPixmap("../image_logo/cloudminds666.png"))
        self.label_9.setObjectName("label_9")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(1370, 120, 301, 811))
        ...
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 1697, 40))
        ...
        self.menu_5 = QtWidgets.QMenu(self.menu_7)
        font = QtGui.QFont()
        font.setPointSize(18)
        ...
        self.menu_11 = QtWidgets.QMenu(self.menu_7)
        font = QtGui.QFont()
        font.setPointSize(18)
        ...
        self.actionGinger1_1_0_Pro = QtWidgets.QAction(MainWindow)
        font = QtGui.QFont()
        font.setPointSize(18)
        self.actionGinger1_1_0_Pro.setFont(font)
        self.actionGinger1_1_0_Pro.setObjectName("actionGinger1_1_0_Pro")
        ...
        self.menu.addAction(self.action_versionCompare)
        self.menu.addAction(self.action_unit)
        self.menu.addAction(self.action_grasp)
        self.menu.addAction(self.action_zero)
        self.menu_2.addAction(self.actionIP128)
        self.menu_2.addAction(self.actionIP200)
        self.menu_2.addAction(self.action_map)
        self.menu_2.addAction(self.action_device)
        ...
        self.Model.addAction(self.actionGinger1_1_0_Pro)
        self.Model.addAction(self.actionGinger1_1_0_Plus)
        self.menu_6.addAction(self.action_dance)
        self.menu_6.addAction(self.action_navigation)
        self.menu_6.addAction(self.action_ultrasonic)
        self.menu_6.addAction(self.action_supernode)
        self.menuAbout.addAction(self.actionversion)
        self.menuCCU.addAction(self.actionUpgrade)
        self.menuCCU.addAction(self.actionOTA)
        self.menu_4.addAction(self.action_IMU)
        self.menu_4.addAction(self.action_gravity)
        self.menu_4.addAction(self.action_gatherparam)
        self.menu_8.addAction(self.action_head_calibrate)
        self.menu_8.addAction(self.action_head_veri)
        self.menu_5.addAction(self.action_9)
        self.menu_9.addAction(self.actionLED)
        self.menu_10.addAction(self.action_10)
        self.menu_11.addAction(self.action_11)
        self.menu_7.addAction(self.menu_5.menuAction())
        self.menu_7.addAction(self.menu_9.menuAction())
        self.menu_7.addAction(self.menu_10.menuAction())
        self.menu_7.addAction(self.menu_11.menuAction())
        self.menu_7.addAction(self.menu_8.menuAction())
        self.menu_3.addAction(self.action_hari_IP128)
        self.menu_3.addAction(self.action_write_document)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_13.setText(_translate("MainWindow", "进度："))
        ...
        self.menu.setTitle(_translate("MainWindow", "整机"))
        self.menu_2.setTitle(_translate("MainWindow", "单步参数导入"))
        self.Model.setTitle(_translate("MainWindow", "机种"))
        self.menu_6.setTitle(_translate("MainWindow", "稳定性测试"))
        self.menuAbout.setTitle(_translate("MainWindow", "About"))
        self.menuCCU.setTitle(_translate("MainWindow", "CCU"))
        self.menu_4.setTitle(_translate("MainWindow", "参数采集"))
        self.menu_7.setTitle(_translate("MainWindow", "零部件"))
        self.menu_8.setTitle(_translate("MainWindow", "头部"))
        self.menu_5.setTitle(_translate("MainWindow", "底盘"))
        self.menu_9.setTitle(_translate("MainWindow", "躯干"))
        self.menu_10.setTitle(_translate("MainWindow", "手臂"))
        self.menu_11.setTitle(_translate("MainWindow", "手掌"))
        self.menu_3.setTitle(_translate("MainWindow", "参数导入"))
        ...
        self.actionUpgrade.setText(_translate("MainWindow", "刷机"))
        ...
        self.actionGinger1_1_0_Pro.setText(_translate("MainWindow", "Ginger1.1.0 Pro"))
