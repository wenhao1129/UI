...
class MyWin(Ui_MainWindow, QMainWindow):
    ...
    def IP200(self):
        ...
        self.data = subprocess.Popen('../copy_document/HostIP200.sh', stdout=subprocess.PIPE, stdin=subprocess.PIPE, shell=True)
        ...
        with open('tmp.txt', 'r') as IP200File:
            ...
            for tempIP200 in IP200File.readlines():
                if IP200failkeyword in tempIP200:
                    testStatusText_IP200 = 'fail'
                    self.lineEdit_teststatus.setText(testStatusText_IP200)
